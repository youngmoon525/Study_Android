...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">시험 프로그램</a>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#portfolio">시험보기</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#about">시험결과보기</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#contact">기타</a></li>
				</ul>
			</div>
		</div>
	</nav>
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">OMR TEST</h1>
			<!-- Icon Divider-->
			...
			<!-- Masthead Subheading-->
			<p class="masthead-subheading font-weight-light mb-0">OMR TEST
				PROGRAM</p>
		</div>
	</header>
	<!-- Portfolio Section-->
	<section class="page-section portfolio" id="portfolio">
		<div class="container">	<a >${test}</a>
			<h1
				class="page-section-heading text-center text-uppercase text-black">결과</h1>
			<table class="type03">
				<tr>
					<th scope="row">문제</td>
					<th scope="row">문제내용</td>
					<th scope="row">실제정답</td>
					<th scope="row">입력한답</td>
					<th scope="row">결과</td>
				</tr>
				<c:forEach items="${list }" var="vo">
				<tr>
					<td>${vo.no }</td>
					<td>${vo.exam_content}</td>
					<td>${vo.exam_dap}</td>
					<td>${vo.user_dap}</td>
					<td>${vo.result}</td>
				</tr>
